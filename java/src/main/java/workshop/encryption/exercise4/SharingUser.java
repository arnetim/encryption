...
public class SharingUser extends User {
    ...
    public void shareContentKeyWith(SharingUser otherUser) {
         ...
         * - encrypt the contentKey for otherUser, using his / her public key
         * - store the encrypted contentKey of the logged in user in a map of sharedContentKeys for otherUser
         *
         */
    }
